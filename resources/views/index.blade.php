                ...
                <section class="bg-grey-demo w-full content-center pb-20">
                    ...
                    <div class="flex flex-col md:flex-row text-center content-center">
                        <div class="flex-1 h-96 px-2 py-2">
                            <div class="rounded-md h-full md:px-12 py-0 px-2">
                                ...
                                <div class="flex flex-col flex-1 text-gray-800 text-xl font-light shadow-lg rounded-md py-2">
                                    <div class="flex-1">
                                        Cristobal Fernandez - CEO Copec
                                    </div>
                                    
                                    <div class="flex-1">
                                        <div class="text-grey-600 font-semibold text-xs pt-2">"Lorem ipsum dolor sit amet, consectetur adipiscing elit."</div>
                                    </div>
                                    <div class="flex-1 flex text-center pt-4">
                                        <div class="flex-1 text-2xl font-semibold py-4">$ 1.080.000 COP</div>
                        ...
                        <div class="flex-1 h-96 px-2 py-2"></div>
                        <div class="flex-1 h-96 px-2 py-2"></div>
